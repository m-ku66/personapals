const questions = [
  ...
  {
    prompt:
      "You found a puppy on the side of the road, asking for food and wagging its tail. What is your first reaction?",
    image: "/7.gif",
  ...
  {
    prompt:
      "You're deciding what movie to watch. You would rather go for the movie that is:",
    image: "/8.gif",
    choice1:
  ...
  {
    prompt:
      "You are on a fun trip and realized that there is no activity planned on the last day. Would you rather..",
    image: "/11.gif",
