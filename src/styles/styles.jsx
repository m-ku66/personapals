const classNames = {
  ...
  button_light:
    "px-[2.5rem] py-[0.5rem] bg-[#D8D7FF]/[0.3] rounded cursor-pointer select-none w-fit h-fit text-center",
  button_focus:
    "px-[2.5rem] py-[0.5rem] bg-[#D8D7FF]/[0.5] rounded cursor-pointer select-none w-fit h-fit text-center",
  button_results:
